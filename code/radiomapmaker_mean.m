...
for i = 1:N
    ...
    bavgrss = brss / b; 
    cavgrss = crss / c;
    b_radiomapdata_mean{y + 1, x + 1} = [aavgrss, bavgrss, cavgrss]; 
end
save(cell2mat(strcat(regexp(name, '[a-z]', 'match'), '_radiomapdata_mean.mat')), 'b_radiomapdata_mean');